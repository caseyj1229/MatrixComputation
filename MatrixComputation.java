...
public class MatrixComputation {
    public static void main(String[] args) {
        ...
        // Only fill up the missing matrices from the project test cases and print them out
        
        // Testcase Step 1
	File f = new File("input.txt");
	SparseMatrix matrixA = SparseMatrix.initializeByInput(f); 
	...
	System.out.println("10. Matrix N = M - I: ");
        SparseMatrix matrixN = matrixA.subtract(matrixB);
        matrixN.print();
